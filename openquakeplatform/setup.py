...
setup(
    ...
    author="",
    author_email="",
    description="OpenQuake Platform, based on GeoNode",
    ...
    packages=['openquakeplatform.vulnerability',
    ...
    dependency_links=[
        'http://github.com/gem/django-chained-selectbox.git@pla26#egg='
        'django-chained-selectbox-0.2.2',
        'http://github.com/gem/django-nested-inlines.git@pla26#egg='
        'django-nested-inlines-0.1.4',
        'http://github.com/gem/django-chained-multi-checkboxes.git@pla26#egg='
        'django-chained-multi-checkboxes-0.4.1',
        'http://github.com/gem/wadofstuff-django-serializers.git@pla26#egg='
