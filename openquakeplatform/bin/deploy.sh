...
sudo /var/lib/geonode/env/bin/python -m pip install git+ssh://${GEM_GIT_REPO}/django-chained-selectbox.git#egg=django-chained-selectbox
sudo /var/lib/geonode/env/bin/python -m pip install git+ssh://${GEM_GIT_REPO}/django-nested-inlines.git#egg=django-nested-inlines
sudo /var/lib/geonode/env/bin/python -m pip install git+ssh://${GEM_GIT_REPO}/django-chained-multi-checkboxes.git#egg=django-chained-multi-checkboxes
sudo /var/lib/geonode/env/bin/python -m pip install git+ssh://${GEM_GIT_REPO}/wadofstuff-django-serializers.git#egg=wadofstuff-django-serializers
