...
extra_deps_install() {
    ...
    pip install -e git@github.com:gem/django-chained-selectbox.git#egg=django-chained-selectbox
    pip install -e git@github.com:gem/django-nested-inlines.git#egg=django-nested-inlines
    pip install -e git@github.com:gem/django-chained-multi-checkboxes.git#egg=django-chained-multi-checkboxes
    pip install -e git@github.com:gem/wadofstuff-django-serializers.git#egg=wadofstuff-django-serializers
