...
extra_deps_install() {
    ...
    pip install -e git+${GEM_GIT_REPO}/django-chained-selectbox.git#egg=django-chained-selectbox
    pip install -e git+${GEM_GIT_REPO}/django-nested-inlines.git#egg=django-nested-inlines
    pip install -e git+${GEM_GIT_REPO}/django-chained-multi-checkboxes.git#egg=django-chained-multi-checkboxes
    pip install -e git+${GEM_GIT_REPO}/wadofstuff-django-serializers.git#egg=wadofstuff-django-serializers
