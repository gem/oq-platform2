...
echo sudo -u postgres psql | sudo -u postgres psql
echo CREATE USER "$GEOUSPW" WITH PASSWORD $GEOUSPW | CREATE USER "$GEOUSPW" WITH PASSWORD "$GEOUSPW"
echo GRANT ALL PRIVILEGES ON DATABASE "$GEOUSPW" to $GEOUSPW | GRANT ALL PRIVILEGES ON DATABASE "$GEOUSPW" to $GEOUSPW
echo GRANT ALL PRIVILEGES ON DATABASE geonode_dev-imports to $GEOUSPW | GRANT ALL PRIVILEGES ON DATABASE geonode_dev-imports to $GEOUSPW
